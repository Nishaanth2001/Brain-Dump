      ...
      {done.length === 0 ? (
        ...
        return (
          <div key={t.id} style={{
            ...
            border:"1px solid rgba(255,255,255,0.05)", borderLeft:`3px solid ${pr.color}`,
            ...
            <div style={{ display:"flex", gap:12, alignItems:"flex-start" }}>
              <div style={{ flex:1 }}>
                ...
                {t.notes && <div style={{ marginTop:8, color:"#3A4A5C", fontSize:11, borderTop:"1px solid rgba(255,255,255,0.04)", paddingTop:8 }}>
