  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius:"50%", background:"radial-gradient(circle,rgba(232,69,69,0.08) 0%,transparent 70%)",
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color:"#E84545", fontSize:11, fontWeight:700, letterSpacing:"0.08em", textTransform:"uppercase" }}>Personal task system</span>
          </div>
