...
// (e.g. your GitHub Pages site) is allowed to fetch() them. This MUST run
// before cors(), because cors() terminates OPTIONS preflight requests
// itself — any middleware after it never runs for preflights, so the header
// would never actually reach Chrome on the request that matters.
