    ...
    <div style={{ padding: "32px 24px", maxWidth: 1200, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6, flexWrap: "wrap", gap: 10 }}>
        ...
        <button
          ...
          style={{ background: "none", border: "none", color: "#2D3748", fontSize: 13, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", display: "flex", alignItems: "center", gap: 6, padding: "6px 0", transition: "color 0.15s" }}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(180px,1fr))", gap: 14 }}>
        {sections.map((s) => {
          ...
          return (
            <div
              key={s.id}
              onClick={() => onOpen(s)}
              style={{ background: "linear-gradient(145deg,#0E1826,#0A1220)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 16, padding: "24px 20px", cursor: "pointer", position: "relative", display: "flex", flexDirection: "column", gap: 10, minHeight: 120, transition: "all 0.2s cubic-bezier(0.34,1.56,0.64,1)" }}
            ...
            >
              <button
                ...
                style={{ position: "absolute", top: 10, right: 10, background: "none", border: "none", color: "rgba(255,255,255,0.1)", fontSize: 13, cursor: "pointer", transition: "color 0.15s", lineHeight: 1 }}
        ...
        <div
          onClick={onAdd}
          style={{ background: "transparent", border: "1px dashed rgba(255,255,255,0.08)", borderRadius: 16, padding: "24px 20px", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 8, minHeight: 120, color: "#2D3748", transition: "all 0.2s" }}
