...
function TaskCard({ task, onCycle, onDelete, onEdit, onProgress, blockedTimes, workHours }) {
  ...
  const schedule = distributeTaskAcrossDays(task, blockedTimes, workHours.start, workHours.end);
