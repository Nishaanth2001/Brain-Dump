  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px 20px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20, flexWrap: "wrap" }}>
        <button
          onClick={onBack}
          style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 8, padding: "6px 12px", color: "#4A5568", fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: 600, transition: "all 0.15s" }}
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 12, alignItems: "center" }}>
          <button
            ...
            style={{ background: "none", border: "none", color: "#2D3748", fontSize: 13, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", transition: "color 0.15s" }}
          ...
          <button
            ...
            style={{ background: "#E84545", color: "#fff", border: "none", borderRadius: 10, padding: "10px 22px", fontSize: 13, fontFamily: "'DM Sans',sans-serif", fontWeight: 700, cursor: "pointer", transition: "all 0.2s", boxShadow: "0 4px 16px rgba(232,69,69,0.3)" }}
        ...
        <div>
          ...
          {sectionTasks.length > 0 && (
            <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
              {[
                { key: "ondemand", icon: "⚡", label: "On Demand", count: odCount },
                { key: "routine",  icon: "🔁", label: "Routine",   count: rtCount },
              ].map((t) => (
          ...
          {sectionTasks.length === 0 ? (
            <div style={{ textAlign: "center", padding: "60px 24px" }}>
              ...
              <button onClick={() => setDumpOpen(true)} style={{ background: "#E84545", color: "#fff", border: "none", borderRadius: 10, padding: "10px 22px", fontSize: 13, fontFamily: "'DM Sans',sans-serif", fontWeight: 700, cursor: "pointer" }}>
                🧠 Start Brain Dump
              </button>
            </div>
          ) : visible.length === 0 ? (
            ...
            visible.map((t) => (
              <TaskCard key={t.id} task={t} onCycle={onCycle} onDelete={onDelete} onEdit={() => setEditTask(t)} />
            ))
          )}
        </div>
